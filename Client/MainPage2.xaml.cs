...
namespace PoleStar
{
    public sealed partial class MainPage2 : Page
    {
        ...
        private IMobileServiceSyncTable<Group> groupTable = App.MobileService.GetSyncTable<Group>(); // offline sync
#else
        ...
        private async Task InsertGroupItem(Group groupItem)
        {
            // Same as ToDoItem but with Task

            await groupTable.InsertAsync(groupItem);
